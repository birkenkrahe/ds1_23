...
1) Getting started (infrastructure: DataCamp, Canvas, GitHub)
2) DataCamp workspace practice
3) Introduction to R
4) First DataCamp assignment "Introduction to R: basics"
...
- Can you see the GMail space "Data Science"?
...
- Can you see my GitHub repo in github.com/birkenkrahe/ds105?

* Course overview

Course and instructor overview information. The original version of
this lecture is on GitHub. There are changes for technical details.
...
- Infinite skills exercise: come up with one to three programs you
 would create if you had infinite programming skills and if you could
 build anything you wanted using any computer and R.

- First assignment: "R basics" (@[[https://app.datacamp.com/learn/courses/introduction-to-r][DataCamp]])
  1) Arithmetic with R (lots of onboard functions)
  2) Variable assignment (different operator)
  3) Basic data types (dynamic typing)

- Next: using the DataCamp coding platform to code in R.
